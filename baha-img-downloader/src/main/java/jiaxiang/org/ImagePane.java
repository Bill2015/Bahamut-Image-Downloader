...
public class ImagePane extends ScrollPane {
    ...
    public ImagePane() {
        ...
        flowPane.setOnScroll((event) -> {
            ...
            setVvalue(vvalue + -deltaY / width); // deltaY/width to make the scrolling equally fast regardless of the
    ...
    public void setImageContent(SimpleListProperty<ImageBox> imageBoxList) {
